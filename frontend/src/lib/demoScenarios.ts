...
export interface BulkConversation {
  fanName: string
  fanInitials: string
  messages: Message[]
}
...
export const BULK_QUEUE_SCENARIO: DemoScenario & {
  conversations: BulkConversation[]
} = {
  id: 'scenario-4-bulk',
  ...
  fanId: 'fan-bulk',
  messages: [
    { id: 's4-fan-a', role: 'user', content: 'Hey beautiful 😍', timestamp: '2026-05-04T14:30:00Z', status: 'approved' },
    { id: 's4-agent-a', role: 'assistant', content: 'Hey! Thanks for the love 💕 How\'s your day going?', timestamp: '2026-05-04T14:30:02Z', status: 'pending' },
    { id: 's4-fan-b', role: 'user', content: 'Loved your latest video!', timestamp: '2026-05-04T14:31:00Z', status: 'approved' },
    { id: 's4-agent-b', role: 'assistant', content: 'Aww thank you! Which one was your favorite? 😊', timestamp: '2026-05-04T14:31:03Z', status: 'pending' },
    { id: 's4-fan-c', role: 'user', content: 'Are you free for a custom?', timestamp: '2026-05-04T14:32:00Z', status: 'approved' },
    { id: 's4-agent-c', role: 'assistant', content: 'I do customs! What did you have in mind? I\'ll check my schedule 💕', timestamp: '2026-05-04T14:32:03Z', status: 'pending' },
  ],
  expectedAction: 'approve',
